g_items = {
	...
	[285] = { "Beginner's Rod", "Lightweight and easy to handle for novice fisher.", 4, 338, 80, 0, 0, -0.02, weight = 1.5},
	[286] = { "Riverbend Rod", "Flexible and designed for precision casting.", 4, 338, 80, 0, 0, -0.02, weight = 1.5},
	[287] = { "Oakstream Rod", "Sturdy and reliable, perfect for medium size fishes.", 4, 338, 80, 0, 0, -0.02, weight = 1.5},
	[288] = { "Mariner's Rod", "Durable and versatile, ideal for large fishes.", 4, 338, 80, 0, 0, -0.02, weight = 1.5},
	[289] = { "Thunderstrike Rod", "Powerful and robust, built to handle huge fishes.", 4, 338, 80, 0, 0, -0.02, weight = 1.5},
	[290] = { "Tier 1 Fish", "#v", 4, 1604, 0, 90, 0, 0.07, weight = function(v) return tonumber(exports.global:explode(":", v)[2]) or 0.1 end, preventSpawn = true},
	[291] = { "Tier 2 Fish", "#v", 4, 1604, 0, 90, 0, 0.07, weight = function(v) return tonumber(exports.global:explode(":", v)[2]) or 0.1 end, preventSpawn = true},
	[292] = { "Tier 3 Fish", "#v", 4, 1604, 0, 90, 0, 0.07, weight = function(v) return tonumber(exports.global:explode(":", v)[2]) or 0.1 end, preventSpawn = true},
	[293] = { "Tier 4 Fish", "#v", 4, 1604, 0, 90, 0, 0.07, weight = function(v) return tonumber(exports.global:explode(":", v)[2]) or 0.1 end, preventSpawn = true},
	[294] = { "Tier 5 Fish", "#v", 4, 1604, 0, 90, 0, 0.07, weight = function(v) return tonumber(exports.global:explode(":", v)[2]) or 0.1 end, preventSpawn = true},
}
